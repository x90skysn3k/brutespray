...
# Combo Option
When you specify a combo option, it will attempt the host:user:pass on each discovered service from Nmap. If you just want to specify `USER:PASS` leave the host blank, see below.
```
127.0.0.1:user:pass
:user:pass
```
